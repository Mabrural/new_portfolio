    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Edit Skill Section</h4>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Skill Information</div>
                        </div>
                        <form action="{{ route('skills.update', $skill) }}" method="POST">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="subname" value="{{ old('subname', $skill->subname) }}">
                                            @error('subname')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon"
                                        rows="4">{{ old('icon', $skill->icon) }}</textarea>
                                    @error('icon')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
