    ...
    <div class="container hero-content">
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <p class="lead mb-4">Spesialis pengembangan aplikasi web dengan Laravel, membangun sistem yang skalabel, aman, dan efisien</p>
  ...
  <section class="py-5" id="portfolio">
    <div class="container py-5">
      ...
      <ul class="nav nav-pills justify-content-center mb-4" id="portfolio-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="ecommerce-tab" data-bs-toggle="pill" data-bs-target="#ecommerce" type="button" role="tab">E-Commerce</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="crm-tab" data-bs-toggle="pill" data-bs-target="#crm" type="button" role="tab">CRM</button>
        </li>
      </ul>
